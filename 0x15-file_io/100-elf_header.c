...
/**
 * print_data - Prints out the data of an ELF header
 * @e_ident: points to an array containing the ELF class
 */
...
/**
 * print_version - prints out the version of an ELF header
...
/**
 * print_osabi - prints out the OS/ABI of an ELF header
 * @e_ident: prints to an array containing the ELF version
 */
